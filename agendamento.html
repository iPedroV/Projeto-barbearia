        ...
        <div class="PainelAG">
            <div class="conteudo">
                <div class="calendario">
                    ...
                    <!-- Modal para Cadstrar -->
                    <link rel="stylesheet" href="./css/Style-Agend-Modal.css">
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="background-color: rgb(255, 255, 255);">
                                    <form method="post" action="" class="cadastro" id="cadastro">
                                            ...
                                            <div class="col-12 " style="margin-bottom: 25px;">
                                                    ...
                                                    <div class="row" style="background-color: rgb(255, 255, 255);">
                                                        <div class="col-md-3">
                                                            <img width="100%" height="180" src="img/corteMasculino.jpg" style="border: 1px solid black;">
                                                            <div>
                                                                <label><strong>Corte Masculino</strong></label>  
                                                        ...
                                                        <div class="col-md-3">
                                                            <img width="100%" height="180" src="img/como-aparar-a-barba-02.jpg" style="border: 1px solid black;">
                                                            <div>
                                                                <label><strong>Barba Masculino</strong></label>  
                                                        ...
                                                        <div class="col-md-3">
                                                            <img width="100%" height="180" src="img/corteFeminino.jpg" style="border: 1px solid black;">
                                                            <div>
                                                                <label><strong>Cabelo Feminino</strong></label>  
                                                                <select name="Perfil" class="form-control">
                                                                    <option>[--Nenhum Serviço--]</option>
                                                                    <option name="cor">Serviço(1)</option>
                                                                    <option name="cor">Serviço(2)</option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <img width="100%" height="180" src="img/manicure-de-sucesso.jpg" style="border: 1px solid black;">
                                                            <div>
                                                                <label><strong>Manicure Feminino</strong></label>  
                                                                <select name="Perfil" class="form-control">
                                                                    <option>[--Nenhum Serviço--]</option>
                                                                    <option name="cor">Serviço(1)</option>
                                                                    <option name="cor">Serviço(2)</option>
                                        ...
                                        <div class="modal-footer" >
                                            <button type="submit" name="excluir" id="enviar" class="btn btn-primary" style="margin-right: 20px;">Enviar</button>
                                            <button type="reset" class="btn btn-secondary" data-bs-dismiss="modal" style="margin-right: 20px;">Cancelar</button>
                                            <input type="reset" class="btn btn-dark btInput" name="limpar" value="Limpar">
                                        </div>
                                    </form>
                                </div>
                            </div>
